...
4.0 MB / 1599 lines / 4215 Layer 1 redactions, sliced from the canonical
session jsonl. Generated by `scripts/regen-redacted-transcript-fixture.mjs`
(internal-only; reads from the maintainer's `~/.claude/projects/`).
Verified clean by `bin/secrets-scan.mjs --files <fixture>`.
